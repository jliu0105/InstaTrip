...
export const Detail: React.FC = () => {
  ...
  return (
    <MainLayout
      breadcrumbItems={['Front page', "Trip", "Detail"]}
    >
      {/* 产品简介 与 日期选择 */}
      ...
      <Anchor style={{marginTop: 20, marginBottom: 20}}>
        <Menu mode="horizontal">
          <Menu.Item key="1">
            <Link href="#product-feature" title="Product Feature"></Link>
          </Menu.Item>
          <Menu.Item key="3"> 
            <Link href="#product-fees" title="Fees"></Link>
          </Menu.Item>
          <Menu.Item key="4"> 
            <Link href="#product-notes" title="Notes"></Link>
          </Menu.Item>
          <Menu.Item key="5">
            <Link href="#product-comments" title="Comments"></Link>
          </Menu.Item>
        </Menu>
      </Anchor>  
      ...
      <div id="product-feature" style={{background: "white", paddingTop: 20}}>
        <Divider orientation="center">
          <Title level={3} >Product Feature</Title>
        </Divider>
        <div 
