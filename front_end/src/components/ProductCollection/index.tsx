            ...
            <Col span={12}>
              <Link to={'detail/'+props.products[0].id}>
                ...
                <div style={{marginLeft: 25, marginRight: 25}}>
                  ...
                  <Text type="danger">$ {props.products[0].price} start</Text>
                </div>
              </Link>
            </Col>
            <Col span={12}>
                ...
                <Col span={12}>
                  <Link to={'detail/'+props.products[1].id}>
                    ...
                    <div>
                      ...
                      <Text type="danger">$ {props.products[1].price} start</Text>
                    </div>
                  </Link>
                </Col>
                <Col span={12}>
                  <Link to={'detail/'+props.products[2].id}>
                    ...
                    <div>
                      ...
                      <Text type="danger">$ {props.products[2].price} start</Text>
                    </div>
                  </Link>
                </Col>
              </Row>
                ...
                <Col span={12}>
                  <Link to={'detail/'+props.products[3].id}>
                    ...
                    <div>
                      ...
                      <Text type="danger">$ {props.products[3].price} start</Text>
                    </div>
                  </Link>
                </Col>
                <Col span={12}>
                  <Link to={'detail/'+props.products[4].id}>
                    ...
                    <div>
                      ...
                      <Text type="danger">$ {props.products[4].price} start</Text>
                    </div>
                  </Link>
                </Col>
              </Row>
            ...
            <Col span={6}>
              <Link to={'detail/'+props.products[5].id}>
                ...
                <div>
                  ...
                  <Text type="danger">$ {props.products[5].price} start</Text>
                </div>
              </Link>
            </Col>
            <Col span={6}>
              <Link to={'detail/'+props.products[6].id}>
                ...
                <div>
                  ...
                  <Text type="danger">$ {props.products[6].price} start</Text>
                </div>
              </Link>
            </Col>
            <Col span={6}>
              <Link to={'detail/'+props.products[7].id}>
                ...
                <div>
                  ...
                  <Text type="danger">$ {props.products[7].price} start</Text>
                </div>
              </Link>
            </Col>
            <Col span={6}>
              <Link to={'detail/'+props.products[8].id}>
                ...
                <div>
                  ...
                  <Text type="danger">$ {props.products[8].price} start</Text>
                </div>
              </Link>
            </Col>
          </Row>
